set moduleName p_gf256v_madd_u3214_2
...
set C_modelName {_gf256v_madd_u3214.2}
set C_modelType { void 0 }
set C_modelArgList {
	{ accu_c int 8 regular {array 110624 { 2 2 } 1 1 }  }
	{ accu_c_offset int 17 regular  }
	{ a int 8 regular {array 211968 { 1 1 } 1 1 }  }
	{ a_offset int 18 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "accu_c", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "a_offset", "interface" : "wire", "bitwidth" : 18, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ a_offset sc_in sc_lv 18 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "a_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "a_offset", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.tmp_s_gf256v_mul_u3215_fu_189", "Parent" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4033", "Max" : "4033"}
	, {"Name" : "Interval", "Min" : "4033", "Max" : "4033"}
]}
...
set Spec2ImplPortList { 
	...
	a_offset { ap_none {  { a_offset in_data 0 18 } } }
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "a_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "gf256_b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.tmp_s_gf256v_mul_u3215_fu_187", "Parent" : "0",
		"CDFG" : "gf256v_mul_u3215",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
