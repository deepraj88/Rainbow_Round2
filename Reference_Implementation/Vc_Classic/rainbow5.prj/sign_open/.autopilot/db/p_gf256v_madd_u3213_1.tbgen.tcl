set moduleName p_gf256v_madd_u3213_1
...
set C_modelName {_gf256v_madd_u3213.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ accu_c int 8 regular {array 256 { 2 2 } 1 1 }  }
	{ a int 8 regular {array 1705536 { 1 1 } 1 1 }  }
	{ a_offset int 64 regular  }
	{ gf256_b uint 8 regular  }
}
...
set portList { 
	...
	{ accu_c_address0 sc_out sc_lv 8 signal 0 } 
	...
	{ accu_c_address1 sc_out sc_lv 8 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "accu_c_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "accu_c", "role": "address0" }} , 
 	...
 	{ "name": "accu_c_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "accu_c", "role": "address1" }} , 
 	...
 	{ "name": "a_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":21, "type": "signal", "bundle":{"name": "a", "role": "address0" }} , 
 	{ "name": "a_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "a", "role": "ce0" }} , 
 	{ "name": "a_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "a", "role": "q0" }} , 
 	{ "name": "a_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":21, "type": "signal", "bundle":{"name": "a", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	accu_c { ap_memory {  { accu_c_address0 mem_address 1 8 }  { accu_c_ce0 mem_ce 1 1 }  { accu_c_we0 mem_we 1 1 }  { accu_c_d0 mem_din 1 8 }  { accu_c_q0 mem_dout 0 8 }  { accu_c_address1 mem_address 1 8 }  { accu_c_ce1 mem_ce 1 1 }  { accu_c_we1 mem_we 1 1 }  { accu_c_d1 mem_din 1 8 }  { accu_c_q1 mem_dout 0 8 } } }
	a { ap_memory {  { a_address0 mem_address 1 21 }  { a_ce0 mem_ce 1 1 }  { a_q0 mem_dout 0 8 }  { a_address1 mem_address 1 21 }  { a_ce1 mem_ce 1 1 }  { a_q1 mem_dout 0 8 } } }
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "a_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "gf256_b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_gf256v_mul_u3214_fu_2092", "Parent" : "0",
