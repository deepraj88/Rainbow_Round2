   ...
   // void extcpk_to_pk( pk_t * pk , const ext_cpk_t * cpk )
        ...
        for(i=0;i<_V1;i++) {
            for(j=i;j<_V1;j++) {
                ...
                printf("%d\n", _PUB_M_BYTE*pub_idx );
                for(k=0;k<_O1_BYTE;k++)(&pk_tmp.pk[ _PUB_M_BYTE*pub_idx ] )[k] = pk.l1_Q1[idx_l12+k];
                for(k=0;k<_O2_BYTE;k++)((&pk_tmp.pk[ _PUB_M_BYTE*pub_idx ]) + _O1_BYTE)[k] = pk.l2_Q1[idx_l22+k];
                idx_l12 += _O1_BYTE;
                idx_l22 += _O2_BYTE;
            }
        }
        ...
        for(i=0;i<_V1;i++) {
            for(j=_V1;j<_V1+_O1;j++) {
                unsigned pub_idx = idx_of_trimat(i,j,_PUB_N);
                for(k=0;k<_O1_BYTE;k++)(&pk_tmp.pk[ _PUB_M_BYTE*pub_idx ] )[k] = pk.l1_Q2[idx_l12+k];
                for(k=0;k<_O2_BYTE;k++)((&pk_tmp.pk[ _PUB_M_BYTE*pub_idx ]) + _O1_BYTE)[k] = pk.l2_Q2[idx_l22+k];
                idx_l12 += _O1_BYTE;
                idx_l22 += _O2_BYTE;
            }
        }
        ...
        for(i=0;i<_V1;i++) {
            for(j=_V1+_O1;j<_PUB_N;j++) {
                unsigned pub_idx = idx_of_trimat(i,j,_PUB_N);
                for(k=0;k<_O1_BYTE;k++)(&pk_tmp.pk[ _PUB_M_BYTE*pub_idx ] )[k] = pk.l1_Q3[idx_l12+k];
                for(k=0;k<_O2_BYTE;k++)((&pk_tmp.pk[ _PUB_M_BYTE*pub_idx ]) + _O1_BYTE)[k] = pk.l2_Q3[idx_l22+k];
                idx_l12 += _O1_BYTE;
                idx_l22 += _O2_BYTE;
            }
        }
        ...
        for(i=_V1;i<_V1+_O1;i++) {
            for(j=i;j<_V1+_O1;j++) {
                unsigned pub_idx = idx_of_trimat(i,j,_PUB_N);
                for(k=0;k<_O1_BYTE;k++)(&pk_tmp.pk[ _PUB_M_BYTE*pub_idx ] )[k] = pk.l1_Q5[idx_l12+k];
                for(k=0;k<_O2_BYTE;k++)((&pk_tmp.pk[ _PUB_M_BYTE*pub_idx ]) + _O1_BYTE)[k] = pk.l2_Q5[idx_l22+k];
                idx_l12 += _O1_BYTE;
                idx_l22 += _O2_BYTE;
            }
        }
        ...
        for(i=_V1;i<_V1+_O1;i++) {
            for(j=_V1+_O1;j<_PUB_N;j++) {
                unsigned pub_idx = idx_of_trimat(i,j,_PUB_N);
                for(k=0;k<_O1_BYTE;k++)(&pk_tmp.pk[ _PUB_M_BYTE*pub_idx ] )[k] = pk.l1_Q6[idx_l12+k];
                for(k=0;k<_O2_BYTE;k++)((&pk_tmp.pk[ _PUB_M_BYTE*pub_idx ]) + _O1_BYTE)[k] = pk.l2_Q6[idx_l22+k];
                idx_l12 += _O1_BYTE;
                idx_l22 += _O2_BYTE;
            }
        }
        ...
        for(i=_V1+_O1;i<_PUB_N;i++) {
            for(j=i;j<_PUB_N;j++) {
                unsigned pub_idx = idx_of_trimat(i,j,_PUB_N);
                for(k=0;k<_O1_BYTE;k++)(&pk_tmp.pk[ _PUB_M_BYTE*pub_idx ] )[k] = pk.l1_Q9[idx_l12+k];
                for(k=0;k<_O2_BYTE;k++)((&pk_tmp.pk[ _PUB_M_BYTE*pub_idx ]) + _O1_BYTE)[k] = pk.l2_Q9[idx_l22+k];
                idx_l12 += _O1_BYTE;
                idx_l22 += _O2_BYTE;
            }
        }
