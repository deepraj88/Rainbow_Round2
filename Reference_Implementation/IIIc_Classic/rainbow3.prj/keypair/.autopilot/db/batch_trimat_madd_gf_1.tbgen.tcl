...
set C_modelArgList {
	...
	{ btriA int 8 regular {array 23976 { 1 1 } 1 1 }  }
	{ B int 8 regular {array 1296 { 1 3 } 1 1 }  }
}
...
set portList { 
	...
	{ btriA_address0 sc_out sc_lv 15 signal 1 } 
	{ btriA_ce0 sc_out sc_logic 1 signal 1 } 
	{ btriA_q0 sc_in sc_lv 8 signal 1 } 
	{ btriA_address1 sc_out sc_lv 15 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "btriA_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "btriA", "role": "address0" }} , 
 	...
 	{ "name": "btriA_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "btriA", "role": "address1" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "bC", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_gf256v_madd_u32_1_fu_123", "Port" : "accu_c"}]},
			{"Name" : "btriA", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_gf256v_madd_u32_1_fu_123", "Port" : "a"}]},
			{"Name" : "B", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_p_gf256v_madd_u32_1_fu_123", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_p_gf256v_madd_u32_1_fu_123.tmp_251_gf256v_mul_u32_fu_191", "Parent" : "1",
		"CDFG" : "gf256v_mul_u32",
		"Protocol" : "ap_ctrl_hs",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "95977", "Max" : "3128617"}
	, {"Name" : "Interval", "Min" : "95977", "Max" : "3128617"}
]}
...
set Spec2ImplPortList { 
	...
	btriA { ap_memory {  { btriA_address0 mem_address 1 15 }  { btriA_ce0 mem_ce 1 1 }  { btriA_q0 mem_dout 0 8 }  { btriA_address1 mem_address 1 15 }  { btriA_ce1 mem_ce 1 1 }  { btriA_q1 mem_dout 0 8 } } }
	B { ap_memory {  { B_address0 mem_address 1 11 }  { B_ce0 mem_ce 1 1 }  { B_q0 mem_dout 0 8 } } }
}
set moduleName batch_trimat_madd_gf_1
set isTaskLevelControl 1
set isCombinational 0
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_p_gf256v_madd_u32_1_fu_123", "Parent" : "0", "Child" : ["2"],
		...
		"Port" : [
			...
			{"Name" : "a_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "gf256_b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_p_gf256v_madd_u32_1_fu_123.tmp_s_gf256v_mul_u32_fu_191", "Parent" : "1",
		"CDFG" : "gf256v_mul_u32",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
