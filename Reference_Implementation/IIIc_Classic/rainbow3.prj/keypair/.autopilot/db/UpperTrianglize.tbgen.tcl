...
set C_modelArgList {
	{ btriC int 8 regular {array 23976 { 2 2 } 1 1 }  }
	{ bA int 8 regular {array 46688 { 1 1 } 1 1 }  }
}
...
set portList { 
	...
	{ btriC_address0 sc_out sc_lv 15 signal 0 } 
	...
	{ btriC_address1 sc_out sc_lv 15 signal 0 } 
	...
	{ bA_address0 sc_out sc_lv 16 signal 1 } 
	{ bA_ce0 sc_out sc_logic 1 signal 1 } 
	{ bA_q0 sc_in sc_lv 8 signal 1 } 
	{ bA_address1 sc_out sc_lv 16 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "btriC_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "btriC", "role": "address0" }} , 
 	...
 	{ "name": "btriC_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "btriC", "role": "address1" }} , 
 	...
 	{ "name": "bA_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "bA", "role": "address0" }} , 
 	...
 	{ "name": "bA_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "bA", "role": "address1" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "1801", "EstimateLatencyMax" : "2113777",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"WaitState" : [
			{"State" : "ap_ST_fsm_state6", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_p_gf256v_add_u3237_fu_99"},
			{"State" : "ap_ST_fsm_state5", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_p_gf256v_add_u3237_fu_99"}],
		"Port" : [
			{"Name" : "btriC", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_gf256v_add_u3237_fu_99", "Port" : "accu_b"}]},
			{"Name" : "bA", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_gf256v_add_u3237_fu_99", "Port" : "a"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_p_gf256v_add_u3237_fu_99", "Parent" : "0",
		"CDFG" : "p_gf256v_add_u3237",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "47", "EstimateLatencyMax" : "1628",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1801", "Max" : "2113777"}
	, {"Name" : "Interval", "Min" : "1801", "Max" : "2113777"}
]}
...
set Spec2ImplPortList { 
	btriC { ap_memory {  { btriC_address0 mem_address 1 15 }  { btriC_ce0 mem_ce 1 1 }  { btriC_we0 mem_we 1 1 }  { btriC_d0 mem_din 1 8 }  { btriC_q0 mem_dout 0 8 }  { btriC_address1 mem_address 1 15 }  { btriC_ce1 mem_ce 1 1 }  { btriC_we1 mem_we 1 1 }  { btriC_d1 mem_din 1 8 }  { btriC_q1 mem_dout 0 8 } } }
	bA { ap_memory {  { bA_address0 mem_address 1 16 }  { bA_ce0 mem_ce 1 1 }  { bA_q0 mem_dout 0 8 }  { bA_address1 mem_address 1 16 }  { bA_ce1 mem_ce 1 1 }  { bA_q1 mem_dout 0 8 } } }
}
set moduleName UpperTrianglize
set isTaskLevelControl 1
set isCombinational 0
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"HasNonBlockingOperation" : "0",
		"WaitState" : [
			{"State" : "ap_ST_fsm_state6", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_p_gf256v_add_u3240_fu_99"},
			{"State" : "ap_ST_fsm_state5", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_p_gf256v_add_u3240_fu_99"}],
		"Port" : [
			{"Name" : "btriC", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_gf256v_add_u3240_fu_99", "Port" : "accu_b"}]},
			{"Name" : "bA", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_gf256v_add_u3240_fu_99", "Port" : "a"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_p_gf256v_add_u3240_fu_99", "Parent" : "0",
		"CDFG" : "p_gf256v_add_u3240",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "btriC", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_gf256v_add_u3248_fu_99", "Port" : "accu_b"}]},
			{"Name" : "bA", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_gf256v_add_u3248_fu_99", "Port" : "a"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_p_gf256v_add_u3248_fu_99", "Parent" : "0",
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "1873", "EstimateLatencyMax" : "2116369",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_p_gf256v_add_u3248_fu_99", "Parent" : "0",
		...
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "49", "EstimateLatencyMax" : "1630",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1873", "Max" : "2116369"}
	, {"Name" : "Interval", "Min" : "1873", "Max" : "2116369"}
]}
...
set ArgLastReadFirstWriteLatency {
	UpperTrianglize {
		btriC {Type IO LastRead 93 FirstWrite 4}
		bA {Type I LastRead 71 FirstWrite -1}}
	p_gf256v_add_u3248 {
		accu_b {Type IO LastRead 93 FirstWrite 4}
		accu_b_offset {Type I LastRead 0 FirstWrite -1}
		a {Type I LastRead 71 FirstWrite -1}
		a_offset {Type I LastRead 0 FirstWrite -1}
		p_num_byte {Type I LastRead 0 FirstWrite -1}}}
...
set ArgLastReadFirstWriteLatency {
	UpperTrianglize {
		btriC {Type IO LastRead 381 FirstWrite 4}
		bA {Type I LastRead 287 FirstWrite -1}}
	p_gf256v_add_u3248 {
		accu_b {Type IO LastRead 381 FirstWrite 4}
		accu_b_offset {Type I LastRead 0 FirstWrite -1}
		a {Type I LastRead 287 FirstWrite -1}
		a_offset {Type I LastRead 0 FirstWrite -1}
		p_num_byte {Type I LastRead 0 FirstWrite -1}}}
