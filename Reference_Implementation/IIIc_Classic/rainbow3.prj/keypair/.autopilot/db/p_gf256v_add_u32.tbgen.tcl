...
set C_modelArgList {
	{ accu_b int 8 regular {array 2448 { 2 2 } 1 1 }  }
	{ accu_b_offset int 12 regular  }
	{ a int 8 regular {array 100 { 1 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "accu_b", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	{ "Name" : "accu_b_offset", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ accu_b_offset sc_in sc_lv 12 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "accu_b_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "accu_b_offset", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	accu_b_offset { ap_none {  { accu_b_offset in_data 0 12 } } }
...
set ArgLastReadFirstWriteLatency {
	p_gf256v_add_u32 {
		...
		accu_b_offset {Type I LastRead 0 FirstWrite -1}
		a {Type I LastRead 67 FirstWrite -1}}}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "15", "EstimateLatencyMax" : "87",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "15", "Max" : "87"}
	, {"Name" : "Interval", "Min" : "15", "Max" : "87"}
]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "31", "Max" : "99"}
	, {"Name" : "Interval", "Min" : "31", "Max" : "99"}
]}
