set moduleName p_gf256v_madd_u32_4
...
set C_modelName {_gf256v_madd_u32.4}
set C_modelType { void 0 }
set C_modelArgList {
	{ accu_c int 8 regular {array 46656 { 2 2 } 1 1 }  }
	{ accu_c_offset int 16 regular  }
	{ a int 8 regular {array 88128 { 1 1 } 1 1 }  }
	{ a_offset int 17 regular  }
	{ gf256_b int 8 regular  }
	{ p_num_byte int 12 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "accu_c", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	{ "Name" : "accu_c_offset", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "a", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "a_offset", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
 	{ "Name" : "gf256_b", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "p_num_byte", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ accu_c_address0 sc_out sc_lv 16 signal 0 } 
	...
	{ accu_c_address1 sc_out sc_lv 16 signal 0 } 
	...
	{ accu_c_offset sc_in sc_lv 16 signal 1 } 
	...
	{ a_offset sc_in sc_lv 17 signal 3 } 
	{ gf256_b sc_in sc_lv 8 signal 4 } 
	{ p_num_byte sc_in sc_lv 12 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "accu_c_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "accu_c", "role": "address0" }} , 
 	...
 	{ "name": "accu_c_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "accu_c", "role": "address1" }} , 
 	...
 	{ "name": "accu_c_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "accu_c_offset", "role": "default" }} , 
 	...
 	{ "name": "a_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "a_offset", "role": "default" }} , 
 	{ "name": "gf256_b", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "gf256_b", "role": "default" }} , 
 	{ "name": "p_num_byte", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "p_num_byte", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_gf256v_mul_u32_fu_270", "Parent" : "0",
		"CDFG" : "gf256v_mul_u32",
		"Protocol" : "ap_ctrl_hs",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "66", "Max" : "2283"}
	, {"Name" : "Interval", "Min" : "66", "Max" : "2283"}
]}
...
set Spec2ImplPortList { 
	accu_c { ap_memory {  { accu_c_address0 mem_address 1 16 }  { accu_c_ce0 mem_ce 1 1 }  { accu_c_we0 mem_we 1 1 }  { accu_c_d0 mem_din 1 8 }  { accu_c_q0 mem_dout 0 8 }  { accu_c_address1 mem_address 1 16 }  { accu_c_ce1 mem_ce 1 1 }  { accu_c_we1 mem_we 1 1 }  { accu_c_d1 mem_din 1 8 }  { accu_c_q1 mem_dout 0 8 } } }
	accu_c_offset { ap_none {  { accu_c_offset in_data 0 16 } } }
	...
	a_offset { ap_none {  { a_offset in_data 0 17 } } }
	gf256_b { ap_none {  { gf256_b in_data 0 8 } } }
	p_num_byte { ap_none {  { p_num_byte in_data 0 12 } } }
}
set moduleName p_gf256v_madd_u32_4
set isTaskLevelControl 1
set isCombinational 0
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "gf256_b", "Type" : "None", "Direction" : "I"},
			{"Name" : "p_num_byte", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_gf256v_mul_u32_fu_272", "Parent" : "0",
		"CDFG" : "gf256v_mul_u32",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
