set moduleName gf256mat_prod_ref_4
...
set C_modelName {gf256mat_prod_ref.4}
set C_modelType { void 0 }
set C_modelArgList {
	{ c int 8 regular {array 36 { 2 2 } 1 1 }  }
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "c", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_gf256v_madd_u3262_1_fu_146", "Port" : "accu_c"}]},
			{"Name" : "matA", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_gf256v_madd_u3262_1_fu_146", "Port" : "a"}]},
			{"Name" : "b", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_p_gf256v_madd_u3262_1_fu_146", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_p_gf256v_madd_u3262_1_fu_146.tmp_279_gf256v_mul_u3269_fu_179", "Parent" : "1",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2432", "Max" : "2432"}
	, {"Name" : "Interval", "Min" : "2432", "Max" : "2432"}
]}
