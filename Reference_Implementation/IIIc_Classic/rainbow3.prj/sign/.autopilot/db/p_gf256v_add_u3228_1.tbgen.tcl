set moduleName p_gf256v_add_u3228_1
...
set C_modelName {_gf256v_add_u3228.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ accu_b int 8 regular {array 68 { 2 2 } 1 1 }  }
...
set portList { 
	...
	{ a_offset sc_in sc_lv 8 signal 2 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	accu_b { ap_memory {  { accu_b_address0 mem_address 1 7 }  { accu_b_ce0 mem_ce 1 1 }  { accu_b_we0 mem_we 1 1 }  { accu_b_d0 mem_din 1 8 }  { accu_b_q0 mem_dout 0 8 }  { accu_b_address1 mem_address 1 7 }  { accu_b_ce1 mem_ce 1 1 }  { accu_b_we1 mem_we 1 1 }  { accu_b_d1 mem_din 1 8 }  { accu_b_q1 mem_dout 0 8 } } }
