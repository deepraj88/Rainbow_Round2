...
set C_modelArgList {
	{ y int 8 regular {array 36 { 2 2 } 1 1 }  }
	{ trimat int 8 regular {array 84456 { 1 1 } 1 1 }  }
	{ x int 8 regular {array 68 { 1 3 } 1 1 }  }
}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "trimat_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "trimat", "role": "address0" }} , 
 	...
 	{ "name": "trimat_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "trimat", "role": "address1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_gf256v_mul_u32_fu_478", "Parent" : "0",
		"CDFG" : "gf256v_mul_u32",
		"Protocol" : "ap_ctrl_hs",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "9881", "Max" : "310577"}
	, {"Name" : "Interval", "Min" : "9881", "Max" : "310577"}
]}
...
set Spec2ImplPortList { 
	y { ap_memory {  { y_address0 mem_address 1 6 }  { y_ce0 mem_ce 1 1 }  { y_we0 mem_we 1 1 }  { y_d0 mem_din 1 8 }  { y_q0 mem_dout 0 8 }  { y_address1 mem_address 1 6 }  { y_ce1 mem_ce 1 1 }  { y_we1 mem_we 1 1 }  { y_d1 mem_din 1 8 }  { y_q1 mem_dout 0 8 } } }
	trimat { ap_memory {  { trimat_address0 mem_address 1 17 }  { trimat_ce0 mem_ce 1 1 }  { trimat_q0 mem_dout 0 8 }  { trimat_address1 mem_address 1 17 }  { trimat_ce1 mem_ce 1 1 }  { trimat_q1 mem_dout 0 8 } } }
	x { ap_memory {  { x_address0 mem_address 1 7 }  { x_ce0 mem_ce 1 1 }  { x_q0 mem_dout 0 8 } } }
}
