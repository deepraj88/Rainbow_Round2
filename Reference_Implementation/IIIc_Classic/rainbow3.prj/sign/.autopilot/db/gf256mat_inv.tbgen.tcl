...
set C_modelName {gf256mat_inv}
set C_modelType { int 1 }
set C_modelArgList {
	{ inv_a int 8 regular {array 1296 { 2 1 } 1 1 }  }
	{ buffer_r int 8 regular {array 2592 { 2 2 } 1 1 }  }
}
...
set portList { 
	...
	{ inv_a_address0 sc_out sc_lv 11 signal 0 } 
	...
	{ inv_a_address1 sc_out sc_lv 11 signal 0 } 
	{ inv_a_ce1 sc_out sc_logic 1 signal 0 } 
	{ inv_a_q1 sc_in sc_lv 8 signal 0 } 
	{ buffer_r_address0 sc_out sc_lv 12 signal 1 } 
	...
	{ buffer_r_address1 sc_out sc_lv 12 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "inv_a_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "inv_a", "role": "address0" }} , 
 	...
 	{ "name": "inv_a_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "inv_a", "role": "address1" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "buffer_r", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_gf256mat_gauss_elim_s_fu_302", "Port" : "mat"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_gf256mat_gauss_elim_s_fu_302", "Parent" : "0", "Child" : ["2", "4", "6", "9"],
		...
		"Port" : [
			{"Name" : "mat", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_p_gf256v_mul_scalar_u_fu_263", "Port" : "a"},
					{"ID" : "2", "SubInstance" : "grp_p_gf256v_madd_u3262_4_fu_253", "Port" : "a"}]}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_gf256mat_gauss_elim_s_fu_302.grp_p_gf256v_madd_u3262_4_fu_253", "Parent" : "1", "Child" : ["3"],
	...
	{"ID" : "3", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_gf256mat_gauss_elim_s_fu_302.grp_p_gf256v_madd_u3262_4_fu_253.grp_gf256v_mul_u3269_fu_251", "Parent" : "2",
	...
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_gf256mat_gauss_elim_s_fu_302.grp_p_gf256v_mul_scalar_u_fu_263", "Parent" : "1", "Child" : ["5"],
		...
		"Port" : [
			...
			{"Name" : "b", "Type" : "None", "Direction" : "I"},
			{"Name" : "p_num_byte", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "5", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_gf256mat_gauss_elim_s_fu_302.grp_p_gf256v_mul_scalar_u_fu_263.grp_gf256v_mul_u3269_fu_211", "Parent" : "4",
		"CDFG" : "gf256v_mul_u3269",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "a", "Type" : "None", "Direction" : "I"},
			{"Name" : "b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_gf256mat_gauss_elim_s_fu_302.grp_gf256_mul_fu_272", "Parent" : "1", "Child" : ["7", "8"],
		"CDFG" : "gf256_mul",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "a", "Type" : "None", "Direction" : "I"},
			{"Name" : "b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "7", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_gf256mat_gauss_elim_s_fu_302.grp_gf256_mul_fu_272.grp_gf16_mul_fu_64", "Parent" : "6",
		"CDFG" : "gf16_mul",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "a", "Type" : "None", "Direction" : "I"},
			{"Name" : "b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "8", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_gf256mat_gauss_elim_s_fu_302.grp_gf256_mul_fu_272.tmp_240_gf16_mul_fu_70", "Parent" : "6",
		"CDFG" : "gf16_mul",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "a", "Type" : "None", "Direction" : "I"},
			{"Name" : "b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_gf256mat_gauss_elim_s_fu_302.grp_gf256_squ_fu_278", "Parent" : "1",
		"CDFG" : "gf256_squ",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "10408", "Max" : "362740"}
	, {"Name" : "Interval", "Min" : "10408", "Max" : "362740"}
]}
...
set Spec2ImplPortList { 
	inv_a { ap_memory {  { inv_a_address0 mem_address 1 11 }  { inv_a_ce0 mem_ce 1 1 }  { inv_a_we0 mem_we 1 1 }  { inv_a_d0 mem_din 1 8 }  { inv_a_q0 mem_dout 0 8 }  { inv_a_address1 mem_address 1 11 }  { inv_a_ce1 mem_ce 1 1 }  { inv_a_q1 mem_dout 0 8 } } }
	buffer_r { ap_memory {  { buffer_r_address0 mem_address 1 12 }  { buffer_r_ce0 mem_ce 1 1 }  { buffer_r_we0 mem_we 1 1 }  { buffer_r_d0 mem_din 1 8 }  { buffer_r_q0 mem_dout 0 8 }  { buffer_r_address1 mem_address 1 12 }  { buffer_r_ce1 mem_ce 1 1 }  { buffer_r_we1 mem_we 1 1 }  { buffer_r_d1 mem_din 1 8 }  { buffer_r_q1 mem_dout 0 8 } } }
}
