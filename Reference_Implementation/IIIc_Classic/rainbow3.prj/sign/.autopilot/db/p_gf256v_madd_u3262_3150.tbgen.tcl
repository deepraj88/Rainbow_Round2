set moduleName p_gf256v_madd_u3262_3150
...
set C_modelName {_gf256v_madd_u3262.3150}
set C_modelType { void 0 }
set C_modelArgList {
	{ accu_c int 8 regular {array 1296 { 2 2 } 1 1 }  }
...
set portList { 
	...
	{ accu_c_address0 sc_out sc_lv 11 signal 0 } 
	...
	{ accu_c_address1 sc_out sc_lv 11 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "accu_c_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "accu_c", "role": "address0" }} , 
 	...
 	{ "name": "accu_c_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "accu_c", "role": "address1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.tmp_271_gf256v_mul_u3269_fu_179", "Parent" : "0",
...
set Spec2ImplPortList { 
	accu_c { ap_memory {  { accu_c_address0 mem_address 1 11 }  { accu_c_ce0 mem_ce 1 1 }  { accu_c_we0 mem_we 1 1 }  { accu_c_d0 mem_din 1 8 }  { accu_c_q0 mem_dout 0 8 }  { accu_c_address1 mem_address 1 11 }  { accu_c_ce1 mem_ce 1 1 }  { accu_c_we1 mem_we 1 1 }  { accu_c_d1 mem_din 1 8 }  { accu_c_q1 mem_dout 0 8 } } }
