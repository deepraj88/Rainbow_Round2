set moduleName p_gf256v_madd_u3262_4
...
set C_modelName {_gf256v_madd_u3262.4}
set C_modelType { void 0 }
set C_modelArgList {
	{ a int 8 regular {array 2592 { 2 2 } 1 1 }  }
	{ accu_c_offset int 12 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "a", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	{ "Name" : "accu_c_offset", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ accu_c_offset sc_in sc_lv 12 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "accu_c_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "accu_c_offset", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_gf256v_mul_u3269_fu_251", "Parent" : "0",
...
set Spec2ImplPortList { 
	...
	accu_c_offset { ap_none {  { accu_c_offset in_data 0 12 } } }
