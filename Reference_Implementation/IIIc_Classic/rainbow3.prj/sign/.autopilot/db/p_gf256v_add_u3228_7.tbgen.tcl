set moduleName p_gf256v_add_u3228_7
...
set C_modelName {_gf256v_add_u3228.7}
set C_modelType { void 0 }
set C_modelArgList {
	{ accu_b int 8 regular {array 140 { 2 2 } 1 1 }  }
	{ accu_b_offset int 9 regular  }
	{ a int 8 regular {array 72 { 1 1 } 1 1 }  }
	{ p_num_byte_offset int 8 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "accu_b", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	{ "Name" : "accu_b_offset", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	{ "Name" : "a", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "p_num_byte_offset", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ accu_b_address0 sc_out sc_lv 8 signal 0 } 
	...
	{ accu_b_address1 sc_out sc_lv 8 signal 0 } 
	...
	{ accu_b_offset sc_in sc_lv 9 signal 1 } 
	...
	{ p_num_byte_offset sc_in sc_lv 8 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "accu_b_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "accu_b", "role": "address0" }} , 
 	...
 	{ "name": "accu_b_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "accu_b", "role": "address1" }} , 
 	...
 	{ "name": "accu_b_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "accu_b_offset", "role": "default" }} , 
 	...
 	{ "name": "p_num_byte_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "p_num_byte_offset", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "47", "Max" : "93"}
	, {"Name" : "Interval", "Min" : "47", "Max" : "93"}
]}
...
set Spec2ImplPortList { 
	accu_b { ap_memory {  { accu_b_address0 mem_address 1 8 }  { accu_b_ce0 mem_ce 1 1 }  { accu_b_we0 mem_we 1 1 }  { accu_b_d0 mem_din 1 8 }  { accu_b_q0 mem_dout 0 8 }  { accu_b_address1 mem_address 1 8 }  { accu_b_ce1 mem_ce 1 1 }  { accu_b_we1 mem_we 1 1 }  { accu_b_d1 mem_din 1 8 }  { accu_b_q1 mem_dout 0 8 } } }
	accu_b_offset { ap_none {  { accu_b_offset in_data 0 9 } } }
	...
	p_num_byte_offset { ap_none {  { p_num_byte_offset in_data 0 8 } } }
}
