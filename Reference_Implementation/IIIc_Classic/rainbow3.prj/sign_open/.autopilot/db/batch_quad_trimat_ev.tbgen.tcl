...
set C_modelArgList {
	{ y int 8 regular {array 72 { 2 2 } 1 1 }  }
	{ trimat int 8 regular {array 710640 { 1 1 } 1 1 }  }
	{ x int 8 regular {array 3456 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ trimat_address0 sc_out sc_lv 20 signal 1 } 
	{ trimat_ce0 sc_out sc_logic 1 signal 1 } 
	{ trimat_q0 sc_in sc_lv 8 signal 1 } 
	{ trimat_address1 sc_out sc_lv 20 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "trimat_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "trimat", "role": "address0" }} , 
 	...
 	{ "name": "trimat_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "trimat", "role": "address1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_gf256v_mul_u32_fu_493", "Parent" : "0",
		"CDFG" : "gf256v_mul_u32",
		"Protocol" : "ap_ctrl_hs",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "39239", "Max" : "2549579"}
	, {"Name" : "Interval", "Min" : "39239", "Max" : "2549579"}
]}
...
set Spec2ImplPortList { 
	...
	trimat { ap_memory {  { trimat_address0 mem_address 1 20 }  { trimat_ce0 mem_ce 1 1 }  { trimat_q0 mem_dout 0 8 }  { trimat_address1 mem_address 1 20 }  { trimat_ce1 mem_ce 1 1 }  { trimat_q1 mem_dout 0 8 } } }
