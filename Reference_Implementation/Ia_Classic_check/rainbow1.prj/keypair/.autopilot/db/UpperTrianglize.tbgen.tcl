...
set C_modelArgList {
	{ btriC int 8 regular {array 8448 { 2 2 } 1 1 }  }
	{ bA int 8 regular {array 16416 { 1 1 } 1 1 }  }
}
...
set portList { 
	...
	{ btriC_address0 sc_out sc_lv 14 signal 0 } 
	...
	{ btriC_address1 sc_out sc_lv 14 signal 0 } 
	...
	{ bA_address0 sc_out sc_lv 15 signal 1 } 
	{ bA_ce0 sc_out sc_logic 1 signal 1 } 
	{ bA_q0 sc_in sc_lv 8 signal 1 } 
	{ bA_address1 sc_out sc_lv 15 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "btriC_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "btriC", "role": "address0" }} , 
 	...
 	{ "name": "btriC_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "btriC", "role": "address1" }} , 
 	...
 	{ "name": "bA_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "bA", "role": "address0" }} , 
 	...
 	{ "name": "bA_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "bA", "role": "address1" }} , 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "btriC", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_gf256v_add_u329_fu_84", "Port" : "accu_b"}]},
			{"Name" : "bA", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_gf256v_add_u329_fu_84", "Port" : "a"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_p_gf256v_add_u329_fu_84", "Parent" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "801", "Max" : "666625"}
	, {"Name" : "Interval", "Min" : "801", "Max" : "666625"}
]}
...
set Spec2ImplPortList { 
	btriC { ap_memory {  { btriC_address0 mem_address 1 14 }  { btriC_ce0 mem_ce 1 1 }  { btriC_we0 mem_we 1 1 }  { btriC_d0 mem_din 1 8 }  { btriC_q0 mem_dout 0 8 }  { btriC_address1 mem_address 1 14 }  { btriC_ce1 mem_ce 1 1 }  { btriC_we1 mem_we 1 1 }  { btriC_d1 mem_din 1 8 }  { btriC_q1 mem_dout 0 8 } } }
	bA { ap_memory {  { bA_address0 mem_address 1 15 }  { bA_ce0 mem_ce 1 1 }  { bA_q0 mem_dout 0 8 }  { bA_address1 mem_address 1 15 }  { bA_ce1 mem_ce 1 1 }  { bA_q1 mem_dout 0 8 } } }
}
set moduleName UpperTrianglize
set isTaskLevelControl 1
set isCombinational 0
