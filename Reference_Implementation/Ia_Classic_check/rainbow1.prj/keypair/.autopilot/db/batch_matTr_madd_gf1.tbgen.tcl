set moduleName batch_matTr_madd_gf1
...
set C_modelName {batch_matTr_madd_gf1}
set C_modelType { void 0 }
set C_modelArgList {
	{ bC int 8 regular {array 16416 { 2 2 } 1 1 }  }
...
set portList { 
	...
	{ bC_address0 sc_out sc_lv 15 signal 0 } 
	...
	{ bC_address1 sc_out sc_lv 15 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bC_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "bC", "role": "address0" }} , 
 	...
 	{ "name": "bC_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "bC", "role": "address1" }} , 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "bC", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_gf16v_madd_u3210_1_fu_92", "Port" : "accu_c"}]},
			{"Name" : "A_to_tr", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "bB", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_gf16v_madd_u3210_1_fu_92", "Port" : "a"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_p_gf16v_madd_u3210_1_fu_92", "Parent" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "790593", "Max" : "790593"}
	, {"Name" : "Interval", "Min" : "790593", "Max" : "790593"}
]}
...
set Spec2ImplPortList { 
	bC { ap_memory {  { bC_address0 mem_address 1 15 }  { bC_ce0 mem_ce 1 1 }  { bC_we0 mem_we 1 1 }  { bC_d0 mem_din 1 8 }  { bC_q0 mem_dout 0 8 }  { bC_address1 mem_address 1 15 }  { bC_ce1 mem_ce 1 1 }  { bC_we1 mem_we 1 1 }  { bC_d1 mem_din 1 8 }  { bC_q1 mem_dout 0 8 } } }
