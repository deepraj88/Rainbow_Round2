...
set ID 182
set hasByteEnable 0
set MemName crypto_sign_keypaXh4
...
set ID 184
set hasByteEnable 0
set MemName crypto_sign_keypaZio
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 1
set AddrRange 16384
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename pk \
    op interface \
    ports { pk_address0 { O 18 vector } pk_ce0 { O 1 bit } pk_we0 { O 1 bit } pk_d0 { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename sk \
    op interface \
    ports { sk_address0 { O 17 vector } sk_ce0 { O 1 bit } sk_we0 { O 1 bit } sk_d0 { O 8 vector } } \
} "
} else {
