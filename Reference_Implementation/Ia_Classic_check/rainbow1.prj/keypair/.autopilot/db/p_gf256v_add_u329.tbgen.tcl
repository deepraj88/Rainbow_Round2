...
set C_modelArgList {
	{ accu_b int 8 regular {array 8448 { 2 2 } 1 1 }  }
	{ accu_b_offset int 16 regular  }
	{ a int 8 regular {array 16416 { 1 1 } 1 1 }  }
	{ a_offset int 14 regular  }
	{ p_num_byte int 11 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "accu_b", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	{ "Name" : "accu_b_offset", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "a", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "a_offset", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
 	{ "Name" : "p_num_byte", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ accu_b_address0 sc_out sc_lv 14 signal 0 } 
	...
	{ accu_b_address1 sc_out sc_lv 14 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "accu_b_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "accu_b", "role": "address0" }} , 
 	...
 	{ "name": "accu_b_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "accu_b", "role": "address1" }} , 
 	...
 	{ "name": "accu_b_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "accu_b_offset", "role": "default" }} , 
 	...
 	{ "name": "p_num_byte", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "p_num_byte", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "22", "Max" : "648"}
	, {"Name" : "Interval", "Min" : "22", "Max" : "648"}
]}
...
set Spec2ImplPortList { 
	accu_b { ap_memory {  { accu_b_address0 mem_address 1 14 }  { accu_b_ce0 mem_ce 1 1 }  { accu_b_we0 mem_we 1 1 }  { accu_b_d0 mem_din 1 8 }  { accu_b_q0 mem_dout 0 8 }  { accu_b_address1 mem_address 1 14 }  { accu_b_ce1 mem_ce 1 1 }  { accu_b_we1 mem_we 1 1 }  { accu_b_d1 mem_din 1 8 }  { accu_b_q1 mem_dout 0 8 } } }
	accu_b_offset { ap_none {  { accu_b_offset in_data 0 16 } } }
	a { ap_memory {  { a_address0 mem_address 1 15 }  { a_ce0 mem_ce 1 1 }  { a_q0 mem_dout 0 8 }  { a_address1 mem_address 1 15 }  { a_ce1 mem_ce 1 1 }  { a_q1 mem_dout 0 8 } } }
	a_offset { ap_none {  { a_offset in_data 0 14 } } }
	p_num_byte { ap_none {  { p_num_byte in_data 0 11 } } }
}
set moduleName p_gf256v_add_u329
set isTaskLevelControl 1
set isCombinational 0
