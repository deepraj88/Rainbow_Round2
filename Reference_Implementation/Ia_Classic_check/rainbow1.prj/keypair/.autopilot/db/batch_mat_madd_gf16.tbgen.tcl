set moduleName batch_mat_madd_gf16
...
set C_modelName {batch_mat_madd_gf16}
set C_modelType { void 0 }
set C_modelArgList {
	{ bC int 8 regular {array 16384 { 2 2 } 1 1 }  }
	{ bA int 8 regular {array 16384 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ bA_address0 sc_out sc_lv 14 signal 1 } 
	{ bA_ce0 sc_out sc_logic 1 signal 1 } 
	{ bA_q0 sc_in sc_lv 8 signal 1 } 
	{ bA_address1 sc_out sc_lv 14 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bA_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "bA", "role": "address0" }} , 
 	...
 	{ "name": "bA_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "bA", "role": "address1" }} , 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "bC", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_gf16v_madd_u3210_2_fu_125", "Port" : "accu_c"}]},
			{"Name" : "bA", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_gf16v_madd_u3210_2_fu_125", "Port" : "a"}]},
			{"Name" : "B", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_p_gf16v_madd_u3210_2_fu_125", "Parent" : "0",
...
set Spec2ImplPortList { 
	...
	bA { ap_memory {  { bA_address0 mem_address 1 14 }  { bA_ce0 mem_ce 1 1 }  { bA_q0 mem_dout 0 8 }  { bA_address1 mem_address 1 14 }  { bA_ce1 mem_ce 1 1 }  { bA_q1 mem_dout 0 8 } } }
