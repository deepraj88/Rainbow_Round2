...
set C_modelArgList {
	...
	{ btriA int 8 regular {array 8448 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ btriA_address0 sc_out sc_lv 14 signal 1 } 
	{ btriA_ce0 sc_out sc_logic 1 signal 1 } 
	{ btriA_q0 sc_in sc_lv 8 signal 1 } 
	{ btriA_address1 sc_out sc_lv 14 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "btriA_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "btriA", "role": "address0" }} , 
 	...
 	{ "name": "btriA_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "btriA", "role": "address1" }} , 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "bC", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_gf16v_madd_u3210_fu_129", "Port" : "accu_c"}]},
			{"Name" : "btriA", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_gf16v_madd_u3210_fu_129", "Port" : "a"}]},
			{"Name" : "B", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_p_gf16v_madd_u3210_fu_129", "Parent" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "67649", "Max" : "919617"}
	, {"Name" : "Interval", "Min" : "67649", "Max" : "919617"}
]}
...
set Spec2ImplPortList { 
	...
	btriA { ap_memory {  { btriA_address0 mem_address 1 14 }  { btriA_ce0 mem_ce 1 1 }  { btriA_q0 mem_dout 0 8 }  { btriA_address1 mem_address 1 14 }  { btriA_ce1 mem_ce 1 1 }  { btriA_q1 mem_dout 0 8 } } }
