...
set C_modelArgList {
	...
	{ bA_to_tr int 8 regular {array 16384 { 1 1 } 1 1 }  }
	{ B int 8 regular {array 512 { 1 3 } 1 1 }  }
}
...
set portList { 
	...
	{ bA_to_tr_address0 sc_out sc_lv 14 signal 1 } 
	{ bA_to_tr_ce0 sc_out sc_logic 1 signal 1 } 
	{ bA_to_tr_q0 sc_in sc_lv 8 signal 1 } 
	{ bA_to_tr_address1 sc_out sc_lv 14 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bA_to_tr_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "bA_to_tr", "role": "address0" }} , 
 	...
 	{ "name": "bA_to_tr_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "bA_to_tr", "role": "address1" }} , 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "bC", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_gf16v_madd_u3210_2_fu_122", "Port" : "accu_c"}]},
			{"Name" : "bA_to_tr", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_p_gf16v_madd_u3210_2_fu_122", "Port" : "a"}]},
			{"Name" : "B", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_p_gf16v_madd_u3210_2_fu_122", "Parent" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "985153", "Max" : "25757761"}
	, {"Name" : "Interval", "Min" : "985153", "Max" : "25757761"}
]}
...
set Spec2ImplPortList { 
	...
	bA_to_tr { ap_memory {  { bA_to_tr_address0 mem_address 1 14 }  { bA_to_tr_ce0 mem_ce 1 1 }  { bA_to_tr_q0 mem_dout 0 8 }  { bA_to_tr_address1 mem_address 1 14 }  { bA_to_tr_ce1 mem_ce 1 1 }  { bA_to_tr_q1 mem_dout 0 8 } } }
	B { ap_memory {  { B_address0 mem_address 1 9 }  { B_ce0 mem_ce 1 1 }  { B_q0 mem_dout 0 8 } } }
}
set moduleName batch_bmatTr_madd_gf
set isTaskLevelControl 1
set isCombinational 0
