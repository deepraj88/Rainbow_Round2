set moduleName p_gf16v_madd_u3211_1
...
set C_modelName {_gf16v_madd_u3211.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ accu_c int 8 regular {array 256 { 2 2 } 1 1 }  }
	{ a int 8 regular {array 148992 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ a_address0 sc_out sc_lv 18 signal 1 } 
	{ a_ce0 sc_out sc_logic 1 signal 1 } 
	{ a_q0 sc_in sc_lv 8 signal 1 } 
	{ a_address1 sc_out sc_lv 18 signal 1 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "a_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "gf16_b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_gf16v_mul_u3215_fu_748", "Parent" : "0",
