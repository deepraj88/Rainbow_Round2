...
set ID 8
set hasByteEnable 0
set MemName rainbow_verify_m_1
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 32
set AddrRange 64
...
set ID 9
set hasByteEnable 0
set MemName rainbow_verify_shdEe
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 8
set AddrRange 64
...
set ID 10
set hasByteEnable 0
set MemName rainbow_verify_buf
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 8
set AddrRange 32
...
set ID 11
set hasByteEnable 0
set MemName rainbow_verify_dieOg
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 8
set AddrRange 32
...
set ID 12
set hasByteEnable 0
set MemName rainbow_verify_cofYi
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 8
set AddrRange 32
...
set ID 13
set hasByteEnable 0
set MemName rainbow_verify_dig8j
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 8
set AddrRange 48
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename digest \
    op interface \
    ports { digest_address0 { O 5 vector } digest_ce0 { O 1 bit } digest_q0 { I 8 vector } digest_address1 { O 5 vector } digest_ce1 { O 1 bit } digest_q1 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename signature \
    op interface \
    ports { signature_address0 { O 12 vector } signature_ce0 { O 1 bit } signature_q0 { I 8 vector } signature_address1 { O 12 vector } signature_ce1 { O 1 bit } signature_q1 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'signature'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename pk \
    op interface \
    ports { pk_address0 { O 18 vector } pk_ce0 { O 1 bit } pk_q0 { I 8 vector } pk_address1 { O 18 vector } pk_ce1 { O 1 bit } pk_q1 { I 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_signature_offset \
    op interface \
    ports { signature_offset { I 64 vector } } \
} "
}
