set moduleName p_gf16v_madd_u32_1
...
set C_modelName {_gf16v_madd_u32.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ accu_c int 8 regular {array 16 { 2 2 } 1 1 }  }
...
set portList { 
	...
	{ accu_c_address0 sc_out sc_lv 4 signal 0 } 
	...
	{ accu_c_address1 sc_out sc_lv 4 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "accu_c_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "accu_c", "role": "address0" }} , 
 	...
 	{ "name": "accu_c_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "accu_c", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	accu_c { ap_memory {  { accu_c_address0 mem_address 1 4 }  { accu_c_ce0 mem_ce 1 1 }  { accu_c_we0 mem_we 1 1 }  { accu_c_d0 mem_din 1 8 }  { accu_c_q0 mem_dout 0 8 }  { accu_c_address1 mem_address 1 4 }  { accu_c_ce1 mem_ce 1 1 }  { accu_c_we1 mem_we 1 1 }  { accu_c_d1 mem_din 1 8 }  { accu_c_q1 mem_dout 0 8 } } }
