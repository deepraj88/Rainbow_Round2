set moduleName p_gf16v_madd_u32_4
...
set C_modelName {_gf16v_madd_u32.4}
set C_modelType { void 0 }
set C_modelArgList {
	{ accu_c int 8 regular {array 1024 { 2 2 } 1 1 }  }
	{ a int 8 regular {array 16384 { 1 1 } 1 1 }  }
	{ a_offset int 15 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "accu_c", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "a_offset", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ accu_c_address0 sc_out sc_lv 10 signal 0 } 
	...
	{ accu_c_address1 sc_out sc_lv 10 signal 0 } 
	...
	{ a_address1 sc_out sc_lv 14 signal 1 } 
	{ a_ce1 sc_out sc_logic 1 signal 1 } 
	{ a_q1 sc_in sc_lv 8 signal 1 } 
	{ a_offset sc_in sc_lv 15 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "accu_c_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "accu_c", "role": "address0" }} , 
 	...
 	{ "name": "accu_c_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "accu_c", "role": "address1" }} , 
 	...
 	{ "name": "a_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "a_offset", "role": "default" }} , 
...
set Spec2ImplPortList { 
	accu_c { ap_memory {  { accu_c_address0 mem_address 1 10 }  { accu_c_ce0 mem_ce 1 1 }  { accu_c_we0 mem_we 1 1 }  { accu_c_d0 mem_din 1 8 }  { accu_c_q0 mem_dout 0 8 }  { accu_c_address1 mem_address 1 10 }  { accu_c_ce1 mem_ce 1 1 }  { accu_c_we1 mem_we 1 1 }  { accu_c_d1 mem_din 1 8 }  { accu_c_q1 mem_dout 0 8 } } }
	...
	a_offset { ap_none {  { a_offset in_data 0 15 } } }
