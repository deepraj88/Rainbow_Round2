set moduleName p_gf256v_add_u32_6_1
...
set C_modelName {_gf256v_add_u32.6.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ a int 8 regular {array 1024 { 0 0 } 0 1 }  }
...
set Spec2ImplPortList { 
	a { ap_memory {  { a_address0 mem_address 1 10 }  { a_ce0 mem_ce 1 1 }  { a_we0 mem_we 1 1 }  { a_d0 mem_din 1 8 }  { a_address1 mem_address 1 10 }  { a_ce1 mem_ce 1 1 }  { a_we1 mem_we 1 1 }  { a_d1 mem_din 1 8 } } }
