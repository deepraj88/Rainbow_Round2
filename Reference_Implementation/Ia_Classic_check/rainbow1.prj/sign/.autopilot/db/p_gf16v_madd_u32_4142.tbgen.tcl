set moduleName p_gf16v_madd_u32_4142
...
set C_modelName {_gf16v_madd_u32.4142}
set C_modelType { void 0 }
set C_modelArgList {
	{ accu_c int 8 regular {array 48 { 2 2 } 1 1 }  }
	{ a int 8 regular {array 1024 { 1 1 } 1 1 }  }
...
set Spec2ImplPortList { 
	...
	a { ap_memory {  { a_address0 mem_address 1 10 }  { a_ce0 mem_ce 1 1 }  { a_q0 mem_dout 0 8 }  { a_address1 mem_address 1 10 }  { a_ce1 mem_ce 1 1 }  { a_q1 mem_dout 0 8 } } }
