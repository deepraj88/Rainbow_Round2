set moduleName p_gf16v_mul_scalar_u3
...
set C_modelArgMapList {[ 
	{ "Name" : "a", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "gf16_b", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ a_offset sc_in sc_lv 10 signal 1 } 
	{ gf16_b sc_in sc_lv 8 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "gf16_b", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "gf16_b", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "27", "Max" : "63"}
	, {"Name" : "Interval", "Min" : "27", "Max" : "63"}
]}
...
set Spec2ImplPortList { 
	...
	gf16_b { ap_none {  { gf16_b in_data 0 8 } } }
