...
set portList { 
	...
	{ hash_address0 sc_out sc_lv 5 signal 11 } 
	{ hash_ce0 sc_out sc_logic 1 signal 11 } 
	{ hash_we0 sc_out sc_logic 1 signal 11 } 
	{ hash_d0 sc_out sc_lv 8 signal 11 } 
	{ hash_address1 sc_out sc_lv 5 signal 11 } 
	{ hash_ce1 sc_out sc_logic 1 signal 11 } 
	{ hash_we1 sc_out sc_logic 1 signal 11 } 
	{ hash_d1 sc_out sc_lv 8 signal 11 } 
}
set NewPortList {[ 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "ctx_data", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_sha256_transform_fu_520", "Port" : "data"}]},
			...
			{"Name" : "k", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_sha256_transform_fu_520", "Port" : "k"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_sha256_transform_fu_520", "Parent" : "0", "Child" : ["2", "3"],
		...
		"Port" : [
			...
			{"Name" : "k", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_sha256_transform_fu_520.k_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_sha256_transform_fu_520.m_U", "Parent" : "1"}]}
