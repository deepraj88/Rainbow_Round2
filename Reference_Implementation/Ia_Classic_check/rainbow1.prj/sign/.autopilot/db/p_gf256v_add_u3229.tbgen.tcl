set moduleName p_gf256v_add_u3229
...
set C_modelName {_gf256v_add_u3229}
set C_modelType { void 0 }
set C_modelArgList {
	{ accu_b int 8 regular {array 512 { 2 2 } 1 1 }  }
...
set portList { 
	...
	{ accu_b_address0 sc_out sc_lv 9 signal 0 } 
	...
	{ accu_b_address1 sc_out sc_lv 9 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "accu_b_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "accu_b", "role": "address0" }} , 
 	...
 	{ "name": "accu_b_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "accu_b", "role": "address1" }} , 
...
set ArgLastReadFirstWriteLatency {
	p_gf256v_add_u3229 {
		accu_b {Type IO LastRead 15 FirstWrite 3}
...
set Spec2ImplPortList { 
	accu_b { ap_memory {  { accu_b_address0 mem_address 1 9 }  { accu_b_ce0 mem_ce 1 1 }  { accu_b_we0 mem_we 1 1 }  { accu_b_d0 mem_din 1 8 }  { accu_b_q0 mem_dout 0 8 }  { accu_b_address1 mem_address 1 9 }  { accu_b_ce1 mem_ce 1 1 }  { accu_b_we1 mem_we 1 1 }  { accu_b_d1 mem_din 1 8 }  { accu_b_q1 mem_dout 0 8 } } }
...
set ArgLastReadFirstWriteLatency {
	p_gf256v_add_u3229 {
		accu_b {Type IO LastRead 31 FirstWrite 3}
...
set ArgLastReadFirstWriteLatency {
	p_gf256v_add_u3229 {
		accu_b {Type IO LastRead 63 FirstWrite 3}
		a {Type I LastRead 63 FirstWrite -1}}}
...
set ArgLastReadFirstWriteLatency {
	p_gf256v_add_u3229 {
		accu_b {Type IO LastRead 127 FirstWrite 3}
		a {Type I LastRead 127 FirstWrite -1}}}
...
set ArgLastReadFirstWriteLatency {
	p_gf256v_add_u3229 {
		accu_b {Type IO LastRead 255 FirstWrite 3}
		a {Type I LastRead 255 FirstWrite -1}}}
...
set ArgLastReadFirstWriteLatency {
	p_gf256v_add_u3229 {
		accu_b {Type IO LastRead 127 FirstWrite 3}
		a {Type I LastRead 65 FirstWrite -1}}}
...
set ArgLastReadFirstWriteLatency {
	p_gf256v_add_u3229 {
		accu_b {Type IO LastRead 255 FirstWrite 3}
		a {Type I LastRead 129 FirstWrite -1}}}
