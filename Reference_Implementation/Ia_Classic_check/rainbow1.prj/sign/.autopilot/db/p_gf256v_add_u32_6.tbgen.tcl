set moduleName p_gf256v_add_u32_6
...
set C_modelName {_gf256v_add_u32.6}
set C_modelType { void 0 }
set C_modelArgList {
	{ accu_b int 8 regular {array 1024 { 2 2 } 1 1 }  }
	{ accu_b_offset int 10 regular  }
	{ a int 8 regular {array 512 { 1 1 } 1 1 }  }
	{ a_offset int 9 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "accu_b", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	{ "Name" : "accu_b_offset", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ accu_b_address0 sc_out sc_lv 10 signal 0 } 
	...
	{ accu_b_address1 sc_out sc_lv 10 signal 0 } 
	...
	{ accu_b_offset sc_in sc_lv 10 signal 1 } 
	{ a_address0 sc_out sc_lv 9 signal 2 } 
	{ a_ce0 sc_out sc_logic 1 signal 2 } 
	{ a_q0 sc_in sc_lv 8 signal 2 } 
	{ a_address1 sc_out sc_lv 9 signal 2 } 
	{ a_ce1 sc_out sc_logic 1 signal 2 } 
	{ a_q1 sc_in sc_lv 8 signal 2 } 
	{ a_offset sc_in sc_lv 9 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "accu_b_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "accu_b", "role": "address0" }} , 
 	...
 	{ "name": "accu_b_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "accu_b", "role": "address1" }} , 
 	...
 	{ "name": "accu_b_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "accu_b_offset", "role": "default" }} , 
 	...
 	{ "name": "a_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "a_offset", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	accu_b { ap_memory {  { accu_b_address0 mem_address 1 10 }  { accu_b_ce0 mem_ce 1 1 }  { accu_b_we0 mem_we 1 1 }  { accu_b_d0 mem_din 1 8 }  { accu_b_q0 mem_dout 0 8 }  { accu_b_address1 mem_address 1 10 }  { accu_b_ce1 mem_ce 1 1 }  { accu_b_we1 mem_we 1 1 }  { accu_b_d1 mem_din 1 8 }  { accu_b_q1 mem_dout 0 8 } } }
	accu_b_offset { ap_none {  { accu_b_offset in_data 0 10 } } }
