...
struct rainbow_secretkey {
    ...
    unsigned char sk_seed[LEN_SKSEED]; //32

    unsigned char s1[_O1_BYTE*_O2];   ///< part of S map // 512
    unsigned char t1[_V1_BYTE*_O1];   ///< part of T map // 512
    unsigned char t4[_V1_BYTE*_O2];   ///< part of T map // 512

    unsigned char t3[_O1_BYTE*_O2];   ///< part of T map // 512

    unsigned char l1_F1[_O1_BYTE * N_TRIANGLE_TERMS(_V1)];  ///< part of C-map, F1, Layer1   8448
    unsigned char l1_F2[_O1_BYTE * _V1*_O1];                ///< part of C-map, F2, Layer1   16384

    unsigned char l2_F1[_O2_BYTE * N_TRIANGLE_TERMS(_V1)];  ///< part of C-map, F1, Layer2   8448
    unsigned char l2_F2[_O2_BYTE * _V1*_O1];                ///< part of C-map, F2, Layer2	16384

    unsigned char l2_F3[_O2_BYTE * _V1*_O2];                ///< part of C-map, F3, Layer2	16384
    unsigned char l2_F5[_O2_BYTE * N_TRIANGLE_TERMS(_O1)];  ///< part of C-map, F5, Layer2	8448
    unsigned char l2_F6[_O2_BYTE * _O1*_O2];                ///< part of C-map, F6, Layer2	16384
} sk_t;
...
void generate_keypair(ext_cpk_t pk,unsigned char * rpk, unsigned char* sk, const unsigned char *sk_seed );
...
void _generate_secretkey( sk_t* sk, const unsigned char sk_seed[32] );
///
