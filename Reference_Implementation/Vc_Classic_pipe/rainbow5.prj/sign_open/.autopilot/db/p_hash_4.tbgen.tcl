...
set C_modelName {_hash.4}
set C_modelType { void 0 }
set C_modelArgList {
	{ m int 8 regular {array 96 { 2 3 } 1 1 }  }
	{ digest_offset int 7 regular  }
	{ m_offset int 7 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "m", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	{ "Name" : "digest_offset", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
 	{ "Name" : "m_offset", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ digest_offset sc_in sc_lv 7 signal 1 } 
	{ m_offset sc_in sc_lv 7 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "digest_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "digest_offset", "role": "default" }} , 
 	{ "name": "m_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "m_offset", "role": "default" }}  ]}
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "k", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_sha256_transform_fu_510", "Port" : "k"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sha256_data_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sha256_state_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_sha256_transform_fu_510", "Parent" : "0", "Child" : ["4", "5"],
		...
		"Port" : [
			...
			{"Name" : "k", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_sha256_transform_fu_510.k_U", "Parent" : "3"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_sha256_transform_fu_510.m_U", "Parent" : "3"}]}
...
set Spec2ImplPortList { 
	m { ap_memory {  { m_address0 mem_address 1 7 }  { m_ce0 mem_ce 1 1 }  { m_we0 mem_we 1 1 }  { m_d0 mem_din 1 8 }  { m_q0 mem_dout 0 8 } } }
	digest_offset { ap_none {  { digest_offset in_data 0 7 } } }
	m_offset { ap_none {  { m_offset in_data 0 7 } } }
}
set moduleName p_hash_4
set isTaskLevelControl 1
set isCombinational 0
