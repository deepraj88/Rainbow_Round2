...
set C_modelName {sha256_final.2}
...
set C_modelArgList {
	...
	{ hash int 8 regular {array 96 { 0 3 } 0 1 }  }
	{ hash_offset int 7 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "ctx_data", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "hash_offset", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ hash_address0 sc_out sc_lv 7 signal 11 } 
	{ hash_ce0 sc_out sc_logic 1 signal 11 } 
	{ hash_we0 sc_out sc_logic 1 signal 11 } 
	{ hash_d0 sc_out sc_lv 8 signal 11 } 
	{ hash_offset sc_in sc_lv 7 signal 12 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "hash_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "hash", "role": "address0" }} , 
 	...
 	{ "name": "hash_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "hash_offset", "role": "default" }}  ]}
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "ctx_data", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_sha256_transform_fu_516", "Port" : "data"}]},
			...
			{"Name" : "k", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_sha256_transform_fu_516", "Port" : "k"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_sha256_transform_fu_516", "Parent" : "0", "Child" : ["2", "3"],
		...
		"Port" : [
			...
			{"Name" : "k", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_sha256_transform_fu_516.k_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_sha256_transform_fu_516.m_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	hash { ap_memory {  { hash_address0 mem_address 1 7 }  { hash_ce0 mem_ce 1 1 }  { hash_we0 mem_we 1 1 }  { hash_d0 mem_din 1 8 } } }
	hash_offset { ap_none {  { hash_offset in_data 0 7 } } }
}
