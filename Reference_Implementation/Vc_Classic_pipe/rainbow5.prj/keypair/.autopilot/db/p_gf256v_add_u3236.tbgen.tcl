set moduleName p_gf256v_add_u3236
...
set C_modelName {_gf256v_add_u3236}
set C_modelType { void 0 }
set C_modelArgList {
	{ accu_b int 8 regular {array 4416 { 2 2 } 1 1 }  }
	{ accu_b_offset int 13 regular  }
	{ a int 8 regular {array 124 { 1 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "accu_b", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	{ "Name" : "accu_b_offset", "interface" : "wire", "bitwidth" : 13, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ accu_b_address0 sc_out sc_lv 13 signal 0 } 
	...
	{ accu_b_address1 sc_out sc_lv 13 signal 0 } 
	...
	{ accu_b_offset sc_in sc_lv 13 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "accu_b_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "accu_b", "role": "address0" }} , 
 	...
 	{ "name": "accu_b_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "accu_b", "role": "address1" }} , 
 	...
 	{ "name": "accu_b_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "accu_b_offset", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "10", "EstimateLatencyMax" : "114",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "10", "Max" : "114"}
	, {"Name" : "Interval", "Min" : "10", "Max" : "114"}
]}
...
set Spec2ImplPortList { 
	accu_b { ap_memory {  { accu_b_address0 mem_address 1 13 }  { accu_b_ce0 mem_ce 1 1 }  { accu_b_we0 mem_we 1 1 }  { accu_b_d0 mem_din 1 8 }  { accu_b_q0 mem_dout 0 8 }  { accu_b_address1 mem_address 1 13 }  { accu_b_ce1 mem_ce 1 1 }  { accu_b_we1 mem_we 1 1 }  { accu_b_d1 mem_din 1 8 }  { accu_b_q1 mem_dout 0 8 } } }
	accu_b_offset { ap_none {  { accu_b_offset in_data 0 13 } } }
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "18", "Max" : "116"}
	, {"Name" : "Interval", "Min" : "18", "Max" : "116"}
]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "35", "Max" : "129"}
	, {"Name" : "Interval", "Min" : "35", "Max" : "129"}
]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "67", "EstimateLatencyMax" : "192",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set ArgLastReadFirstWriteLatency {
	p_gf256v_add_u3236 {
		accu_b {Type IO LastRead 64 FirstWrite 4}
		accu_b_offset {Type I LastRead 0 FirstWrite -1}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "67", "Max" : "192"}
	, {"Name" : "Interval", "Min" : "67", "Max" : "192"}
]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "15", "EstimateLatencyMax" : "114",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "15", "Max" : "114"}
	, {"Name" : "Interval", "Min" : "15", "Max" : "114"}
]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "31", "Max" : "116"}
	, {"Name" : "Interval", "Min" : "31", "Max" : "116"}
]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "127", "EstimateLatencyMax" : "192",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "127", "Max" : "192"}
	, {"Name" : "Interval", "Min" : "127", "Max" : "192"}
]}
