...
set ID 263
set hasByteEnable 0
set MemName crypto_sign_keypaMgi
...
set ID 264
set hasByteEnable 0
set MemName crypto_sign_keypaNgs
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 8
...
set ID 265
set hasByteEnable 0
set MemName crypto_sign_keypaOgC
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 8
...
set ID 266
set hasByteEnable 0
set MemName crypto_sign_keypaQgW
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 8
set AddrRange 56448
...
set ID 267
set hasByteEnable 0
set MemName crypto_sign_keypaRg6
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 8
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename pk \
    op interface \
    ports { pk_address0 { O 21 vector } pk_ce0 { O 1 bit } pk_we0 { O 1 bit } pk_d0 { O 8 vector } pk_address1 { O 21 vector } pk_ce1 { O 1 bit } pk_we1 { O 1 bit } pk_d1 { O 8 vector } } \
} "
} else {
