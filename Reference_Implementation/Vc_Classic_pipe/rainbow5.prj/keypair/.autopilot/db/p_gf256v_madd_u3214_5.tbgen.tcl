set moduleName p_gf256v_madd_u3214_5
...
set C_modelName {_gf256v_madd_u3214.5}
set C_modelType { void 0 }
set C_modelArgList {
	{ accu_c int 8 regular {array 211968 { 2 2 } 1 1 }  }
	{ accu_c_offset int 18 regular  }
	{ a int 8 regular {array 211968 { 1 1 } 1 1 }  }
	{ a_offset int 33 regular  }
	{ gf256_b int 8 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "accu_c", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	{ "Name" : "accu_c_offset", "interface" : "wire", "bitwidth" : 18, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ accu_c_address0 sc_out sc_lv 18 signal 0 } 
	...
	{ accu_c_address1 sc_out sc_lv 18 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "accu_c_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "accu_c", "role": "address0" }} , 
 	...
 	{ "name": "accu_c_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "accu_c", "role": "address1" }} , 
 	...
 	{ "name": "accu_c_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "accu_c_offset", "role": "default" }} , 
 	...
 	{ "name": "a_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "a", "role": "address1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.tmp_s_gf256v_mul_u3215_fu_185", "Parent" : "0",
...
set Spec2ImplPortList { 
	accu_c { ap_memory {  { accu_c_address0 mem_address 1 18 }  { accu_c_ce0 mem_ce 1 1 }  { accu_c_we0 mem_we 1 1 }  { accu_c_d0 mem_din 1 8 }  { accu_c_q0 mem_dout 0 8 }  { accu_c_address1 mem_address 1 18 }  { accu_c_ce1 mem_ce 1 1 }  { accu_c_we1 mem_we 1 1 }  { accu_c_d1 mem_din 1 8 }  { accu_c_q1 mem_dout 0 8 } } }
	accu_c_offset { ap_none {  { accu_c_offset in_data 0 18 } } }
	a { ap_memory {  { a_address0 mem_address 1 18 }  { a_ce0 mem_ce 1 1 }  { a_q0 mem_dout 0 8 }  { a_address1 mem_address 1 18 }  { a_ce1 mem_ce 1 1 }  { a_q1 mem_dout 0 8 } } }
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "a_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "gf256_b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.tmp_257_gf256v_mul_u3215_fu_185", "Parent" : "0",
		"CDFG" : "gf256v_mul_u3215",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
